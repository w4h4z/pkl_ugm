        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Data Operator PKL</h3>
            </div>
            <div class="box-body">  
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/admin/edit_operator_submit/<?php echo $petugas1->PEMBIMBING_ID; ?>">
<?php
    echo '
...
?>
            <div class="form-group">
                ...
                <a href="<?php echo base_url(); ?>index.php/admin/data_operator" class="btn btn-danger">Cancel</a>
            </div>
            </form>
            </div>
          </div>
