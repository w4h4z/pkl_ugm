      ...
      <!-- Main content -->
       <section class="content">
	    <div class="row" style="margin-top: 100px">
	     ...
	     <h4><p style="line-height: 1.4; text-align: justify;">Direktotat Sistem dan Sumber Daya Informasi (DSSDI yang berdiri pada tanggal 18 Februari 1978 merupakan pusat pengolahan data dan penyajian informasi yang telah mewujudkan Tri Dharma Perguruan Tinggi bagi seluruh civitas akademika UGM dan masyarakat umum. Berdiri dengan nama Pusat Komputer atau PUSKOM tetapi karena seiring bertambahnya kebutuhan akan sumber daya teknologi informasi dan bisnis universitas maka berubah nama menjadi DSSDI. Karena usaha dan semangat untuk berkembang, UGM berhasil menempati posisi pertama dalam peringkat universitas di Indonesia versi Webometrics melalui kinerja situs web dan menempati posisi 724 world rank.</p></h4> 
	     </div>
	     <div class="col-lg-6">
